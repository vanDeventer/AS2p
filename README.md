...
# Version's aim
In this commit, we introduce the serial bus I2C or TWI using the LM77 temperature sensor.
## Exercises
- Step through the code looking at the I/O registers.
- Look into the other solution presented with the board documentation.